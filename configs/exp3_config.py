...
def get_args():
    ...
    parser.add_argument(
        '--ig-render-mode',
        default='headless',
        help='which visualization mode to use: headless | pbgui | iggui')
    parser.add_argument(
        '--ig-config',
        default='./configs/ig_configs/humanoid_basic_exp3.yaml',
        help='igibson config file')
    parser.add_argument(
        '--algo',
        default='ppo',
    ...
    parser.add_argument(
        '--gail-experts-dir',
        default='dataset/dataset_cabinet_mixed_clean',
        help='directory that contains expert demonstrations for gail')
    parser.add_argument(
        '--gail-experts-data-length',
        type=int,
        default=84,
        help='size of expert dataset')
    parser.add_argument(
        '--gail-batch-size',
        type=int,
        default=128,
